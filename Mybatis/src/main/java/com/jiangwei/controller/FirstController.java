...
//        rs.createDeployment().addClasspathResource("com/jiangwei/diagram/process.bpmn").deploy();
...
//        // 部署流程，只要是符合BPMN2规范的XML文件，理论上都可以被ACTIVITI部署
//        repositoryService.createDeployment().addClasspathResource("com/jiangwei/diagram/process.bpmn").deploy();
//        // 开启流程，myprocess是流程的ID
